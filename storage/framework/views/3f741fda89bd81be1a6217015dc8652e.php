<?php $__env->startSection('title', 'Interactive Floorplan'); ?>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="d-flex align-items-center mb-2">
                                            <span class="badge bg-primary me-3">Current Space: <?php echo e($existingBooking->floorplanItem->label ?? 'N/A'); ?></span>
                                            <span class="badge bg-<?php echo e($existingBooking->status === 'confirmed' ? 'success' : 'warning'); ?> me-2">
                                                <?php echo e(ucfirst($existingBooking->status)); ?>

                                            </span>
                                            <span class="text-muted small">Progress: Step <?php echo e($existingBooking->current_booking_progress ?? 1); ?> of 4</span>
                                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="border border-2 border-dashed border-secondary rounded bg-light position-relative canvas-container" style="min-height: 500px;">
                                <canvas id="floorplanCanvas" width="<?php echo e($floorplanDesign->canvas_width ?? 800); ?>" height="<?php echo e($floorplanDesign->canvas_height ?? 600); ?>" style="border: 1px solid #ccc; cursor: pointer;"></canvas>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="card border-primary">
                                <div class="card-body">
                                    <h6 class="card-title"><?php echo e($existingBooking->floorplanItem->label ?? 'N/A'); ?></h6>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <small class="text-muted">Step <?php echo e($existingBooking->current_booking_progress ?? 1); ?> of 4</small>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            function initCanvas() {
                ...
                <?php if($floorplanDesign): ?>
                    const canvasWidth = <?php echo e($floorplanDesign->canvas_width); ?>;
                    const canvasHeight = <?php echo e($floorplanDesign->canvas_height); ?>;
                <?php else: ?>
                ...
                <?php if($floorplanDesign): ?>
                    ...
                    if (canvas.style) {
                        canvas.style.backgroundColor = '<?php echo e($floorplanDesign->bg_color ?? "#ffffff"); ?>';
                    }
                    
                    // Store global colors for use in drawing
                    window.globalFloorplanColors = {
                        bgColor: '<?php echo e($floorplanDesign->bg_color ?? "#ffffff"); ?>',
                        fillColor: '<?php echo e($floorplanDesign->fill_color ?? "#e5e7eb"); ?>',
                        strokeColor: '<?php echo e($floorplanDesign->stroke_color ?? "#374151"); ?>',
                        textColor: '<?php echo e($floorplanDesign->text_color ?? "#111827"); ?>',
                        borderWidth: <?php echo e($floorplanDesign->border_width ?? 2); ?>,
                        fontFamily: '<?php echo e($floorplanDesign->font_family ?? "Arial"); ?>',
            ...
            function loadFloorplanDefaults() {
                ...
                const floorplanData = <?php echo json_encode($event->floorplanDesign ?? null, 15, 512) ?>;
                if (floorplanData) {
            ...
            function loadFloorplan() {
                <?php if($floorplanDesign): ?>
                    const floorplanData = <?php echo json_encode($floorplanDesign, 15, 512) ?>;
            ...
            function loadAndMergeBookingData() {
                ...
                const eventBookings = <?php echo json_encode($event->bookings ?? [], 15, 512) ?>;
            ...
            function showItemInfo(shape, event) {
                ...
                if (shape.booking_status === 'available') {
                    ...
                    <?php if($existingBooking): ?>
                    if (<?php echo e($existingBooking->floorplan_item_id ?? 0); ?> === shape.id) {
                        ...
                        bookNowBtn.href = '<?php echo e($existingBooking ? route("bookings.owner-form-token", ["eventSlug" => $event->slug, "accessToken" => $existingBooking->access_token]) : "#"); ?>';
                        ...
                        const currentPrice = <?php echo e($existingBooking->floorplanItem->price ?? 0); ?>;
                        const newPrice = shape.price || 0;
                        
                        if (newPrice > currentPrice) {
                            // Show upgrade option
                            bookNowBtn.innerHTML = '<i class="bi bi-arrow-up-circle me-2"></i>Upgrade to This Space';
                            bookNowBtn.href = `/event/<?php echo e($event->slug); ?>/booking/<?php echo e($existingBooking->access_token); ?>/change-space/${shape.id}`;
        ...
        function loadAvailableAlternatives() {
            ...
            const availableItems = shapes.filter(shape => 
                ...
                shape.id !== <?php echo e($existingBooking->floorplan_item_id ?? 0); ?>
        ...
        function changeToNewSpace(itemId) {
            if (confirm('Are you sure you want to change to this new space? This will remove your current booking and start over.')) {
                ...
                window.location.href = `/event/<?php echo e($event->slug); ?>/book/${itemId}`;
            }
        }
        ...
        function removeCurrentBooking() {
            if (confirm('Are you sure you want to remove your current booking? This action cannot be undone.')) {
                ...
                fetch(`/event/<?php echo e($event->slug); ?>/booking/<?php echo e($existingBooking->access_token ?? ''); ?>/remove`, {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        window.location.href = '<?php echo e(route("events.public.floorplan", $event->slug)); ?>';
                    } else {
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\exhibition-app\resources\views/bookings/floorplan.blade.php ENDPATH**/ ?>