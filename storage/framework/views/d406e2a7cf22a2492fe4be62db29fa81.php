                                    ...
                                    <div class="card-body py-2">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select class="form-select form-select-sm" id="itemLabelPosition">
                                                <option value="">Use Default (<?php echo e(ucfirst($defaultLabelPosition ?? 'top')); ?>)</option>
                                        ...
                                        <div class="mb-2" id="labelCustomizationGroup">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select form-select-sm" id="itemLabelFontSize">
                                                    <option value="">Use Default (<?php echo e($floorplanDesign->default_label_font_size ?? 12); ?>px)</option>
                                                    <option value="8">8px (Small)</option>
                                                    <option value="10">10px (Medium)</option>
                                        ...
                                        <div class="mb-2" id="textCustomizationGroup" style="display: none;">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select form-select-sm" id="itemFontSize">
                                                    <option value="">Use Default (<?php echo e($floorplanDesign->font_size ?? 12); ?>px)</option>
                                                    <option value="8">8px (Small)</option>
                                                    <option value="10">10px (Medium)</option>
                                                    <option value="12">12px (Standard)</option>
                                                    <option value="14">14px (Large)</option>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select form-select-sm" id="itemFontFamily">
                                                    <option value="">Use Default (<?php echo e($floorplanDesign->font_family ?? 'Arial'); ?>)</option>
                                                    <option value="Arial">Arial</option>
                                                    <option value="Helvetica">Helvetica</option>
                                                    <option value="Times New Roman">Times New Roman</option>
                                                    <option value="Georgia">Georgia</option>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function saveFloorplan() {
                ...
                // Send to backend
                fetch(`<?php echo e(route('events.floorplan.save', $event)); ?>`, {
                    method: 'POST',
                    headers: {
            ...
            function loadFloorplan() {
                fetch(`<?php echo e(route('events.floorplan.load', $event)); ?>`)
            ...
            function checkOrphanedBookings() {
                ...
                fetch(`/events/<?php echo e($event->slug); ?>/floorplan/check-orphaned-bookings`)
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
                            if (data.count > 0) {
            ...
            function cleanupOrphanedBookings() {
                ...
                fetch(`/events/<?php echo e($event->slug); ?>/floorplan/cleanup-orphaned-bookings`, {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\xampp\htdocs\exhibition-app\resources\views/events/floorplan.blade.php ENDPATH**/ ?>