...
unset($__errorArgs, $__bag); ?>" 
                                           id="email" name="email" value="<?php echo e(old('email')); ?>" autocomplete="off" required>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-3">
                        <h6 class="text-<?php echo e($role->name === 'admin' ? 'danger' : ($role->name === 'organizer' ? 'warning' : 'secondary')); ?>">
                        ...
                        <div class="small">
                            ...
                            <ul class="list-unstyled mt-1">
                                ...
                                <li class="text-muted">• <?php echo e($permission->display_name); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($role->permissions->count() > 3): ?>
                                <li class="text-muted">• +<?php echo e($role->permissions->count() - 3); ?> more...</li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\exhibition-app\resources\views/admin/users/create.blade.php ENDPATH**/ ?>