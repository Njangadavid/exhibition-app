                ...
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">
                            ...
                            Selected Space: <?php echo e($booking->floorplanItem->label ?? $booking->floorplanItem->item_name ?? 'Booth'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <span class="ms-2"><?php echo e($booking->floorplanItem->max_capacity ?? 'N/A'); ?> people</span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <span class="ms-2">$<?php echo e($booking->floorplanItem->price ?? 'N/A'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <span class="ms-2"><?php echo e($booking->boothOwner->form_responses['name'] ?? 'N/A'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <small class="text-muted">
                            <?php if($memberForm): ?>
                                <?php echo e($memberForm->description ?? 'Manage your booth members'); ?>
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            ...
                            <div class="alert alert-info mb-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <span class="badge bg-primary ms-2"><?php echo e($booking->floorplanItem->max_capacity ?? 5); ?> members</span>
                                    </div>
                                    <div>
                                        <span class="text-muted">
                                            <span id="currentMemberCount">0</span> of <?php echo e($booking->floorplanItem->max_capacity ?? 5); ?> members added
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                                                 <a href="<?php echo e(route('bookings.owner-form-token', ['eventSlug' => $event->slug, 'accessToken' => $booking->boothOwner->access_token])); ?>" class="btn btn-outline-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    <?php if($memberForm): ?>
        ...
        initializeMemberManagement(<?php echo json_encode($memberForm->getFormJsonAttribute(), 15, 512) ?>);
    <?php endif; ?>
...
function initializeMemberManagement(formData) {
    ...
    <?php if($transformedBoothMembers && $transformedBoothMembers->count() > 0): ?>
        window.currentMembers = <?php echo json_encode($transformedBoothMembers->pluck('form_responses'), 15, 512) ?>;
    <?php endif; ?>
    
    // Initialize form data and current members
    window.currentFormData = <?php echo json_encode($memberForm, 15, 512) ?>;
    window.currentMembers = <?php echo json_encode($transformedBoothMembers ?? [], 15, 512) ?>;
...
function findMemberId(memberData) {
    ...
    <?php if($transformedBoothMembers && $transformedBoothMembers->count() > 0): ?>
        const boothMembers = <?php echo json_encode($transformedBoothMembers, 15, 512) ?>;
    ...
    console.error('Available booth members:', <?php echo json_encode($transformedBoothMembers ?? [], 15, 512) ?>);
    return null;
}
...
function confirmDeleteMember() {
    ...
    fetch('<?php echo e(route("bookings.delete-member", ["eventSlug" => $event->slug, "accessToken" => $booking->boothOwner->access_token, "memberId" => ":memberId"])); ?>'.replace(':memberId', memberId), {
        method: 'DELETE',
        headers: {
...
function saveMemberEdit() {
    ...
    fetch('<?php echo e(route("bookings.update-member", ["eventSlug" => $event->slug, "accessToken" => $booking->boothOwner->access_token, "memberId" => ":memberId"])); ?>'.replace(':memberId', memberId), {
        method: 'POST',
        body: submitData,
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
...
function addMember() {
    ...
    // Check capacity
    const maxCapacity = <?php echo e($booking->floorplanItem->max_capacity ?? 5); ?>;
    ...
    submitData.append('_token', '<?php echo e(csrf_token()); ?>');
    
    fetch('<?php echo e(route("bookings.save-members", ["eventSlug" => $event->slug, "accessToken" => $booking->boothOwner->access_token])); ?>', {
        method: 'POST',
        body: submitData,
        headers: {
            'X-Requested-With': 'XMLHttpRequest'
...
function continueToPayment() {
    ...
    window.location.href = '<?php echo e(route("bookings.payment", ["eventSlug" => $event->slug, "accessToken" => $booking->boothOwner->access_token])); ?>';
}
...
function resendMemberEmail() {
    if (confirm('Are you sure you want to resend the member registration email? This will send the email again to all members.')) {
        ...
        fetch('<?php echo e(route("bookings.resend-member-email", ["eventSlug" => $event->slug, "accessToken" => $booking->boothOwner->access_token])); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\exhibition-app\resources\views/bookings/member-form.blade.php ENDPATH**/ ?>