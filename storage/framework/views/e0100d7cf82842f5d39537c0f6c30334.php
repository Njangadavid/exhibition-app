<?php $__env->startSection('title', 'Owner Registration'); ?>
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-header bg-primary text-white">
                            <h5 class="mb-0">
                                ...
                                Selected Space: <?php echo e($item->label ?? $item->item_name ?? 'Booth'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <span class="ms-2"><?php echo e($item->max_capacity ?? 'N/A'); ?> people</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <span class="ms-2">$<?php echo e($item->price ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo e($isEditing ? route('bookings.process-owner-token', ['eventSlug' => $event->slug, 'accessToken' => $boothOwner->access_token]) : route('bookings.process-owner', ['eventSlug' => $event->slug, 'itemId' => $item->id])); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('name', $boothOwner->form_responses['name'] ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('email', $boothOwner->form_responses['email'] ?? '')); ?>" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <div class="phone-input-wrapper">
                                                    <input type="tel" class="form-control form-control-sm <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('phone', $boothOwner->form_responses['phone'] ?? '')); ?>" required>
                                </div>
                                                <input type="hidden" id="owner_phone_country" name="phone_country" value="<?php echo e(old('phone_country', $boothOwner->form_responses['phone_country'] ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" class="form-control form-control-sm <?php $__errorArgs = ['company_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(old('company_name', $boothOwner->form_responses['company_name'] ?? '')); ?>" required>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="mb-2">
                                                ...
                                                <textarea class="form-control form-control-sm <?php $__errorArgs = ['company_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    placeholder="Enter your company address"><?php echo e(old('company_address', $boothOwner->form_responses['company_address'] ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-2">
                                                ...
                                                <input type="url" class="form-control form-control-sm <?php $__errorArgs = ['company_website'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(old('company_website',$boothOwner->form_responses['company_website'] ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select form-select-sm <?php $__errorArgs = ['country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <option value="<?php echo e($code); ?>" <?php echo e(old('country', $boothOwner->form_responses['country'] ?? '') == $code ? 'selected' : ''); ?>>
                                                        <?php echo e(mb_chr(ord($code[0]) + 127397) . mb_chr(ord($code[1]) + 127397)); ?> <?php echo e($name); ?>
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-warning text-dark py-2">
                                    <h6 class="mb-0">
                                        ...
                                        <?php if(!($boothOwner && isset($boothOwner->form_responses['company_logo']) && $boothOwner->form_responses['company_logo']) || !($boothOwner && isset($boothOwner->form_responses['booth_name']) && $boothOwner->form_responses['booth_name'])): ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                <label for="company_logo" class="form-label small mb-1">
                                                    ...
                                                    <?php if(!($boothOwner && isset($boothOwner->form_responses['company_logo']) && $boothOwner->form_responses['company_logo'])): ?>
                                            ...
                                            <?php endif; ?>
                                                <input type="file" class="form-control form-control-sm <?php $__errorArgs = ['company_logo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    data-has-existing="<?php echo e($boothOwner && isset($boothOwner->form_responses['company_logo']) && $boothOwner->form_responses['company_logo'] ? 'true' : 'false'); ?>">
                                                <div class="form-text small">
                                                <?php if($boothOwner && isset($boothOwner->form_responses['company_logo'])): ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" class="form-control form-control-sm <?php $__errorArgs = ['booth_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('booth_name', $boothOwner->form_responses['booth_name'] ?? '')); ?>"
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="url" class="form-control form-control-sm <?php $__errorArgs = ['social_facebook'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(old('social_facebook', $boothOwner->form_responses['social_facebook'] ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="url" class="form-control form-control-sm <?php $__errorArgs = ['social_twitter'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(old('social_twitter', $boothOwner->form_responses['social_twitter'] ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="url" class="form-control form-control-sm <?php $__errorArgs = ['social_linkedin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(old('social_linkedin', $boothOwner->form_responses['social_linkedin'] ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="url" class="form-control form-control-sm <?php $__errorArgs = ['social_instagram'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   value="<?php echo e(old('social_instagram', $boothOwner->form_responses['social_instagram'] ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="<?php echo e($isEditing ? route('events.public.floorplan-token', ['event' => $event->slug, 'accessToken' => $boothOwner->access_token]) : route('events.public.floorplan', $event->slug)); ?>" class="btn btn-outline-secondary">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\exhibition-app\resources\views/bookings/owner-form.blade.php ENDPATH**/ ?>