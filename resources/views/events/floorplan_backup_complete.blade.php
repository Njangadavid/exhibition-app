    ...
    <div class="py-4">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-4" id="propertiesPanel">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-outline-secondary" id="hidePropertiesBtn">
                        ...
                        <div class="card-body">
                            <form class="d-flex flex-column gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Floorplan Name</label>
                                        <input type="text" class="form-control" id="floorplanName" placeholder="Main Hall Floorplan">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <input type="color" value="#ffffff" class="form-control form-control-color" id="bgColor" style="width: 60px; height: 40px;">
                                            <input type="text" value="#ffffff" class="form-control" id="bgColorText" placeholder="#ffffff">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <input type="color" value="#e5e7eb" class="form-control form-control-color" id="fillColor" style="width: 60px; height: 40px;">
                                            <input type="text" value="#e5e7eb" class="form-control" id="fillColorText" placeholder="#e5e7eb">
                                        </div>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Border/Stroke Color</label>
                                        <div class="d-flex gap-2">
                                            <input type="color" value="#374151" class="form-control form-control-color" id="strokeColor" style="width: 60px; height: 40px;">
                                            <input type="text" value="#374151" class="form-control" id="strokeColorText" placeholder="#374151">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <input type="color" value="#111827" class="form-control form-control-color" id="textColor" style="width: 60px; height: 40px;">
                                            <input type="text" value="#111827" class="form-control" id="textColorText" placeholder="#111827">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Styling Options -->
                                <div>
                                    <h6 class="fw-bold mb-3">Styling Options</h6>
                                ...
                                <!-- Grid Settings -->
                                <div>
                                    <h6 class="fw-bold mb-3">Grid Settings</h6>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <input type="color" value="#e5e7eb" class="form-control form-control-color" id="gridColor" style="width: 60px; height: 40px;">
                                            <input type="text" value="#e5e7eb" class="form-control" id="gridColorText" placeholder="#e5e7eb">
                                        </div>
                                    </div>
                                ...
                                <!-- Booking Properties -->
                                <div>
                                    <h6 class="fw-bold mb-3">Booking Properties</h6>
                                    
                                    <div class="mb-3">
                                        <label class="form-label">Default Booth Capacity</label>
                                        <input type="number" class="form-control" id="defaultBoothCapacity" value="5" min="1" max="20">
                                        <small class="form-text text-muted">Maximum number of people per booth</small>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Label Prefix</label>
                                        <input type="text" class="form-control" id="labelPrefix" value="A" maxlength="3">
                                        <small class="form-text text-muted">Prefix for booth labels (A, B, C, etc.)</small>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Starting Label Number</label>
                                        <input type="number" class="form-control" id="startingLabelNumber" value="1" min="1" max="99">
                                        <small class="form-text text-muted">Starting number for booth labels</small>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Default Label Position</label>
                                        <select class="form-select" id="defaultLabelPosition">
                                        ...
                                        <small class="form-text text-muted">Position of labels relative to items</small>
                                    </div>

                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input" id="enableAutoLabeling" checked>
                                        <label class="form-check-label" for="enableAutoLabeling">Enable Auto-Labeling</label>
                                    </div>
                                </div>
                                ...
                                <div class="pt-3">
                                    ...
                                    <button type="button" class="btn btn-secondary w-100" id="resetDefaults">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div id="itemPropertiesPanel" class="card" style="display: none; position: absolute; right: 20px; top: 20px; z-index: 1000; min-width: 300px;">
                                    <div class="card-header">
                                        <h6 class="mb-0">
                                            <i class="bi bi-gear me-2"></i>
                                            Item Properties
                                        </h6>
                                        <button type="button" class="btn-close" id="closeItemProperties"></button>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="itemLabel" placeholder="Enter custom label">
                                        </div>
                                        
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="itemBookable">
                                                <label class="form-check-label" for="itemBookable">Bookable</label>
                                            </div>
                                        </div>
                                        
                                        <div class="mb-3" id="capacityGroup" style="display: none;">
                                            <label class="form-label">Max Capacity</label>
                                            <input type="number" class="form-control" id="itemMaxCapacity" min="1" max="20">
                                        </div>
                                        
                                        <div class="d-flex gap-2">
                                            <button type="button" class="btn btn-primary btn-sm" id="updateItemProperties">
                                                <i class="bi bi-check me-1"></i>
                                                Update
                                            </button>
                                            <button type="button" class="btn btn-secondary btn-sm" id="resetItemProperties">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function populateItemPropertiesPanel(shape) {
                ...
                // Show/hide capacity group based on bookable status
            ...
            function drawItemLabel(shape) {
                if (shape.label) {
                    const width = shape.width || shape.size || (shape.radius ? shape.radius * 2 : 40);
                    const height = shape.height || shape.size || (shape.radius ? shape.radius * 2 : 40);
