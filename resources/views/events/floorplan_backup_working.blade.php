    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function drawShape(shape) {
                ...
                const centerX = shape.x + (shape.width || shape.radius * 2) / 2;
                const centerY = shape.y + (shape.height || shape.radius * 2) / 2;
                ...
                // Add label if shape has one
                if (shape.label) {
                    ctx.fillStyle = '#000';
                    ctx.font = '10px Arial';
                    ctx.textAlign = 'center';
                    ctx.fillText(shape.label, centerX, centerY + (shape.height || shape.radius * 2) + 15);
                    ctx.textAlign = 'start';
                }
            }
            ...
            function drawRestroom(shape) {
                ...
                ctx.font = '16px Arial';
                ctx.textAlign = 'center';
                ctx.fillText('WC', shape.x + (shape.width || 40)/2, shape.y + (shape.height || 40)/2 + 6);
                ctx.textAlign = 'start';
                ...
                ctx.lineWidth = 2;
                ctx.beginPath();
                ctx.arc(shape.x + (shape.width || 40)/2, shape.y + (shape.height || 40) - 5, 8, 0, Math.PI);
                ctx.stroke();
            }
            
            function drawSecurity(shape) {
                ctx.fillStyle = '#FFD700';
                ctx.fillRect(shape.x, shape.y, shape.width || 30, shape.height || 30);
                ctx.strokeRect(shape.x, shape.y, shape.width || 30, shape.height || 30);
                
                // Shield symbol
                ctx.fillStyle = '#000';
                ctx.beginPath();
                ctx.arc(shape.x + (shape.width || 30)/2, shape.y + (shape.height || 30)/2, 8, 0, 2 * Math.PI);
                ctx.stroke();
                ...
                ctx.font = '8px Arial';
                ctx.textAlign = 'center';
                ctx.fillText('SEC', shape.x + (shape.width || 30)/2, shape.y + (shape.height || 30)/2 + 3);
                ctx.textAlign = 'start';
            }
            ...
            canvas.addEventListener('mousedown', function(e) {
                ...
                // Calculate drag offset if shape is selected
                if (selectedShape) {
